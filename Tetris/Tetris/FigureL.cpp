...
//------------------------------------------------------------------------------------------
//--
void FigureL::rotate(bool _ccw)
{
	vec2f pos_0[] ={ vec2f(0.0f, 0.0f), vec2f(1.0f, 0.0f), vec2f(0.0f, 0.0f), vec2f(1.0f, 0.0f) };
	vec2f pos_1[] ={ vec2f(1.0f, 0.0f), vec2f(0.0f, 0.0f), vec2f(0.0f, 1.0f), vec2f(1.0f, 1.0f) };
	vec2f pos_2[] ={ vec2f(2.0f, 0.0f), vec2f(0.0f, 1.0f), vec2f(1.0f, 1.0f), vec2f(1.0f, 2.0f) };
	vec2f pos_3[] ={ vec2f(2.0f, 1.0f), vec2f(0.0f, 2.0f), vec2f(2.0f, 1.0f), vec2f(0.0f, 2.0f) };
